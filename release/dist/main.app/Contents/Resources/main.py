...
def correct(answer):
    ...
    # okay button
    okay_button_img = pygame.image.load("okay.png").convert_alpha()
...
def play_add_sub(numbers, digits, speed):
    ...
    # buttons
    submit_button_img = pygame.image.load("submit.png").convert_alpha()
...
def add_sub_game():
    ...
    back_button_img = pygame.image.load("back.png").convert_alpha()
...
def main():
    ...
    # load button images
    add_sub_img = pygame.image.load('add_sub.png').convert_alpha()
    mult_img = pygame.image.load('mult.png').convert_alpha()
    div_img = pygame.image.load('div.png').convert_alpha()
